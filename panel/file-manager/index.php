<?php
require 'key.php'; // Removing this line will open up this script to the world, without a password. Do not remove unless you edit the details below to use a password.
/**
 * @file
...
# Colours #
$ft["settings"]["COLOURONE"]         = "#464646"; // Dark background colour - also used on menu links.
...
$ft["plugins"]["edit"] = array(
 "settings" => array(
   "editlist" => "txt html htm css conf php xml",
   "converttabs" => FALSE
 )
);
/*
...
function ft_edit_info() {
  return array(
    ...
    'settings' => array(
      'editlist' => array(
        'default' => 'txt html htm css conf php xml',
