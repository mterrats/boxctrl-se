	...
	<!-- Navigation -->
		...
		<div class="navigation">
				<ul>
					...
					<li><a href="database-management.php" class="active">Database Management</a></li> <!-- usage " class="active" " for color -->
	...
	<!-- Subnav -->
		...
		<div class="toplinks">	
				...
				<div class="in minitext">
					...
					<p>View the <a href="help-files.php#databasemanagement">help </a>file for this section. Click <a href="sql-manager/adminer.php">here</a> for a non-iframe version of the database manager.</p>
				</div>
				<div class="in">			
				<center><iframe src="sql-manager/adminer.php" width="100%" height="900px" frameborder="0"></iframe></center>
				</div>					
